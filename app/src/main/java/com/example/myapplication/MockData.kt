...
object MockData {
    val appList = listOf(
        AppItem(
            id = "1",
            icon = R.drawable.check_circle_unread_24px,
        ...
        AppItem(
            id = "4",
            icon = R.drawable.assistant_navigation_24px,
        ...
        AppItem(
            id = "6",
            icon = R.drawable.assured_workload_24px,
            title = "Tinkoff",
